...
import { jobSearchFeatures, employerFeatures } from "../../utils/data";
    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl mb:text-5xl font-bold mb-6 text-gray-900">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            employer, our platform offers a comprehensive suite of features
            designed to streamline your job search and hiring process.
          </p>
        </div>
          ...
          <div>
            ...
            {employerFeatures.map((feature, index) => (
              <div
                ...
                key={index}
              >
                <div className="flex-shrink-0 w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center group-hover:bg-purple-200 transition-colors duration-300">
