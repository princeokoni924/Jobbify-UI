  ...
  const handleSubmit = async (event) =>
   {
    ...
    try{
      ...
      setFormState((prev)=>({
        ...
        error:
        {
          submit: error.response?.data?.message || "Login fail, please check your credentials and try again"
        }
      }));
    }
   };
    ...
    return(
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        ...
        className="bg-white p-8  shadow-xl rounded-xl w-full text-center max-w-md">
         ...
         <p className="text-gray-600 mb-4">You've successfully logged into your account.</p>
         {/* Spinner */}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50  px-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6" autoComplete="true" autoSave="true">
          {/* Email */}
          <div>
            <label
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 outline-none
                 rounded-lg border ${
                   formState.error.email ? "border-red-500" 
                   : "border-gray-300"
