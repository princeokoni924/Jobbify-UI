...
const ApplicationView = () => {
  ...
  const handleSelectApplicant = useCallback((app) => {
    setSelectApplicant(app);
  }, []);
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex gap-4 items-center mb-4 sm:mb-0">
              <button     
                ...
                aria-label="Go back to manage jobs"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:p-0 pb-8">
          {Object.keys(groupApplication).length === 0 ? (
            ...
            <div className="space-y-8">
              {Object.values(groupApplication).map(({ job, applications }) => (
                <div
                    ...
                    <div className="space-y-4">
                      {applications.map((app) => (
                        <ApplicationCard
                          ...
                          onViewProfile={handleSelectApplicant}
                        />
                      ))}
                    </div>
                  </div>
...
//       setApplications(response.data);
//     } catch (err) {
//       console.error("Fail to fetch an application", err);
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//   // Group job application by ID so that all applications for the same job are kept together.
//   const groupApplication = useMemo(() => {
//     // Filter out applications with missing applicant or job data
//     const filtered = applications.filter(
//       (app) => app?.job?.title && app?.applicant
//     );
...
//                                     {getInitials(app.applicant?.name || "N/A")}
//                                   </span>
//                                 </div>
//                               )}
//                             </div>
...
//                             <button
//                               onClick={() => setSelectApplicant(app)}
//                               className="inline-flex items-center gap-2 px-3
...
//         {selectApplicant && (
//           <ApplicationProfilePreview
//             selectApplicant={selectApplicant.status}
//             setSelectApplicants={setSelectApplicant}
//             handleDownloadResume={handleDownloadResume}
//             handleClose={() => {
//               setSelectApplicant(null);
//               fetchApplication();
