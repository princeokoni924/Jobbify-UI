     ...
     shadow-gray-200 border border-white/20 p-4 lg:p-8 mb-6 lg:mb-0">
      <div className="flex flex-col gap-4 lg:gap-6">
        <div className="text-center lg:text-left">
          <h1 className="text-xl lg:text-2xl font-semibold text-gray-800 mb-2">Find your Dream job here</h1>
          <p className="text-sm text-gray-600 lg:text-base">Discover opportunities that matches your passion</p>
        </div>
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2 lg:py-2.5 border
               border-gray-200 rounded-xl
                lg:rounded-xl outline-0 text-base bg-white/50 backdrop-blur-sm"
              value={filters.keyword}
              onChange={(e) => handleFilterChange("keyword", e.target.value)}
              placeholder="Jobs, titles, companys, or keywords"
            />
          </div>
          {/* Location */}
