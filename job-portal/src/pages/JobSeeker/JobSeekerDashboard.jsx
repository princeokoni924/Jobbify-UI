...
// //   // function to fetch job from api
...
// //       setErrors("Fail to fetch job. Please try again");
// //       setJobs([]);
// //     } finally {
// //       setIsLoading(false);
// //     }
...
// //   // fetch job when filter change (debouced)
// //   useEffect(() => {
// //     const timeOutId = setTimeout(() => {
// //       const apiFilters = {
...
// //       // call API if there are meaningfull filter
// //       const hasFilter = Object.values(apiFilters).some(
// //         (values) =>
// //           values !== "" &&
// //           values !== false &&
// //           values !== null &&
...
// //       if (isSaved) {
// //         await axiosInstance.delete(API_PATHS.JOBS.UNSAVE_JOB(jobId));
// //         toast.success("You've successfully removed this job from save list");
// //       } else {
// //         await axiosInstance.post(API_PATHS.JOBS.SAVE_JOB(jobId));
// //         toast.success("Job successfully added to the save list");
// //       }
// //       fetchJobs();
// //     } catch (err) {
// //       console.log("Fail to save job", err);
// //       toast.error("Something went wrong. try again in few minute.");
// //     }
// //   };
...
// //       if (jobId) {
// //         await axiosInstance.post(API_PATHS.APPLICATIONS.APPLY_TO_JOB(jobId));
// //         toast.success("You've successfully apply to this job");
// //       }
// //       fetchJobs();
// //     } catch (err) {
// //       console.log(err);
// //       const errMsg = err?.response.data?.message;
// //       toast.error(errMsg || "Something went wrong. try again in few minutes");
// //     }
// //   };
...
// //   }
// //   return (
// //     <div className="bg-gradient-to-r from-blue-50 via-white to-gray-100">
// //       <Navbar />
...
// //                 border-white/20 p-6 sticky top-24 "
// //               >
// //                 <h3 className="font-bold text-gray-800 text-xl mb-6">
// //                   Filter Jobs
// //                 </h3>
...
// //                      gap-2 bg-white px-4 py-2
// //                      rounded-xl border border-gray-200 
// //                      font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200 "
...
// //                           viewMode === "grid"
// //                             ? "bg-blue-500 text-white shadow-sm"
// //                             : "text-gray-600 hover:text-800 hover:bg-gray-100"
// //                         }`}
...
// //                     <Search className="w-16 h-16 mx-auto" />
// //                   </div>
// //                   <h3 className="text-xl text-gray-900 mb-3 font-bold lg:text-2xl ">No job available</h3>
// //                   <p className="text-gray-600 mb-6">Try adjust your search criteria or filter</p>
// //                   <button className="bg-blue-600 text-white px-6 py-3 rounded-xl 
// //                   font-semibold hover:bg-blue-700
// //                   transition-colors duration-200 " onClick={clearAllFilter}>
// //                     Clear Filter
// //                   </button>
// //                 </div>
// //               ) : (
...
// //                         onToggleSave={() =>
// //                           toggleSavedJob(job._id, job.isSaved)
// //                         }
// //                         onApply={() => applyToJob(job._id)}
// //                       />
// //                     ))}
